    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex h-20 items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-2 flex-shrink-0">
                ...
                <span class="text-xl font-extrabold tracking-tight text-slate-900">Skill<span class="text-blue-600">Store</span></span>
            </div>

            <div class="hidden md:flex items-center gap-8 text-sm font-semibold text-slate-600">
                <a href="{{ route('home') }}" class="text-blue-600 border-b-2 border-blue-600 pb-1">Beranda</a>
                <a href="#Project" class="hover:text-slate-900 transition">Project</a>
                <a href="#Category" class="hover:text-slate-900 transition">Kategori</a>
                <a href="#Featured" class="hover:text-slate-900 transition">Leaderboard</a>
                <a href="#About" class="hover:text-slate-900 transition">Tentang</a>
            </div>
            ...
            <div class="flex items-center gap-4 flex-1 max-w-xs md:max-w-sm justify-end">
                <form action="{{ route('projects.index') }}#Project" method="GET" class="relative w-full hidden sm:block">
                    <input type="text" name="search" placeholder="Cari project..." value="{{ request('search') }}" class="w-full pl-4 pr-10 py-2.5 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition">
                ...
                @guest
                    <a href="{{ route('login') }}" class="text-xs font-bold text-slate-700 hover:text-slate-900 transition px-3 py-2">Login</a>
