<section class="relative overflow-hidden bg-gradient-to-b from-blue-50/30 via-white to-white pt-16 pb-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="relative z-10">
            ...
            <h1 class="text-4xl sm:text-5xl font-black text-slate-900 tracking-tight leading-[1.15] mb-6">
            ...
            <div class="flex flex-wrap gap-4 mb-8">
                ...
                @guest
                    <a href="{{ route('register') }}" class="inline-flex items-center justify-center px-6 py-3 rounded-xl font-bold text-xs text-blue-600 bg-white border border-slate-200 hover:bg-slate-50 transition gap-2 shadow-sm">
                        Upload Project
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" /></svg>
                    </a>
                @else
                    <a href="{{ route('dashboard.projects.create') }}" class="inline-flex items-center justify-center px-6 py-3 rounded-xl font-bold text-xs text-blue-600 bg-white border border-slate-200 hover:bg-slate-50 transition gap-2 shadow-sm">
                        Upload Project
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" /></svg>
                    </a>
                @endguest
            ...
            <div class="flex items-center gap-3 border-t border-slate-100 pt-6 w-fit">
                ...
                <p class="text-xs text-slate-500 font-medium">
                    Bergabung dengan <span class="font-bold text-slate-800">500+ siswa</span><br>dan bagikan project terbaikmu 🚀
                </p>
            </div>
        </div>
