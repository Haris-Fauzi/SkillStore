<footer class="bg-white border-t border-slate-100 py-12 mt-12" id="About">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div class="md:col-span-1">
                <div class="flex items-center gap-2 mb-4">
                    ...
                    <span class="text-lg font-extrabold tracking-tight text-slate-900">Skill<span class="text-blue-600">Store</span></span>
                </div>
            ...
            <div>
                <h4 class="text-xs font-bold text-slate-800 uppercase tracking-wider mb-4">Jelajahi</h4>
            ...
            <div>
                <h4 class="text-xs font-bold text-slate-800 uppercase tracking-wider mb-4">Kontribusi</h4>
                <ul class="space-y-2.5 text-xs font-semibold text-slate-500">
            ...
            <div>
                <h4 class="text-xs font-bold text-slate-800 uppercase tracking-wider mb-4">Tentang Kami</h4>
                <ul class="space-y-2.5 text-xs font-semibold text-slate-500">
