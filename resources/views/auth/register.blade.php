...
{{-- 1. Load library SweetAlert2 & Axios lewat CDN jika belum ada di project-mu --}}
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
<script src="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js"></script>

{{-- 2. Taruh logika JavaScript kamu di sini --}}
<script>
            ...
            try {
                ...
                if (response.status === 200 || response.status === 201) {
                    Swal.fire({
                        ...
                        background: document.documentElement.classList.contains('dark') ? '#020617' : '#ffffff', // Menyesuaikan dark/light mode otomatis
                        color: document.documentElement.classList.contains('dark') ? '#f8fafc' : '#0f172a',
                        showConfirmButton: true,
                        confirmButtonText: 'Login Sekarang',
                        buttonsStyling: false, // Matikan styling bawaan agar bisa pakai Tailwind
                        customClass: {
                            ...
                            confirmButton: 'w-full py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs transition shadow-md shadow-blue-500/10 cursor-pointer focus:outline-none focus:ring-4 focus:ring-blue-500/20'
                        }
                    }).then((result) => {
                ...
                // Pop-up Gagal yang juga dibuat Modern
                Swal.fire({
                    ...
                    customClass: {
                        ...
                        title: 'text-xl font-black tracking-tight text-slate-900 dark:text-slate-100 pt-2',
                        htmlContainer: 'text-xs text-slate-500 dark:text-slate-400 leading-relaxed px-2 pb-2',
                        confirmButton: 'w-full py-2.5 rounded-xl bg-red-600 hover:bg-red-700 text-white font-bold text-xs transition shadow-md shadow-red-500/10 cursor-pointer'
                    }
                });
            }
        });
