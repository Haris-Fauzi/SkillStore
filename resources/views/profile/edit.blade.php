...
<div class="py-8 bg-slate-50 dark:bg-slate-800/50 min-h-[90vh]">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="bg-white dark:bg-slate-950 transition-colors duration-300 border border-slate-100 rounded-3xl p-6 shadow-sm dark:border-slate-800 flex items-center gap-4">
        ...
        <div class="bg-white dark:bg-slate-950 transition-colors duration-300 border border-slate-100 rounded-3xl p-6 sm:p-8 shadow-sm dark:border-slate-800">
            <div class="max-w-xl">
                @include('profile.partials.update-profile-information-form')
            </div>
        </div>

        <div class="bg-white border border-slate-100 rounded-3xl p-6 sm:p-8 shadow-sm dark:border-slate-800">
            <div class="max-w-xl">
                @include('profile.partials.update-password-form')
            </div>
        </div>

        <div class="bg-white dark:bg-slate-950 transition-colors duration-300 border border-rose-100 bg-rose-50/10 rounded-3xl p-6 sm:p-8 shadow-sm dark:border-slate-800">
            <div class="max-w-xl">
